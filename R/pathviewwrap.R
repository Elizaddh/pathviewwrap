...
pathviewwrap <- function(fq.dir="mouse_raw", ref.dir = NA, phenofile= NA, outdir="results", endness="SE",  
    ...
    aligned_proj <- run_qAlign(corenum, endness, sampleFile, genomeFile,geneAnnotation)
    geneLevels <-run_qCount(genomeFile, geneAnnotation, aligned_proj, corenum, outdir)
